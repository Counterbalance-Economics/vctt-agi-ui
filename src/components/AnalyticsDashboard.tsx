...
export default function AnalyticsDashboard({ onClose }: Props) {
  ...
  if (loading) {
    return (
      <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/70 backdrop-blur-sm z-[100]">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-900 border border-vctt-gold rounded-xl p-8 shadow-2xl">
  ...
  if (!analytics) {
    return (
      <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/70 backdrop-blur-sm z-[100]">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-900 border border-red-500 rounded-xl p-8 shadow-2xl max-w-md">
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 bg-black/80 backdrop-blur-sm z-[100]">
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-900 rounded-2xl w-[90%] max-w-4xl max-h-[90vh] overflow-hidden shadow-2xl border border-gray-700">
        {/* Header */}
